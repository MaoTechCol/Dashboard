...
def _run_compat_migrations() -> None:
    ...
    if "daily_mileage_snapshots" in existing_tables:
        ...
        _ensure_column("daily_mileage_snapshots", "closure_status", "VARCHAR(32) DEFAULT 'provisional'")
        _ensure_column("daily_mileage_snapshots", "coverage_status", "VARCHAR(32) DEFAULT 'covered'")
        _ensure_column("daily_mileage_snapshots", "sample_count", "INTEGER DEFAULT 0")
        _ensure_column("daily_mileage_snapshots", "first_observed_at", "DATETIME")
        _ensure_column("daily_mileage_snapshots", "last_observed_at", "DATETIME")
        _ensure_column("daily_mileage_snapshots", "closed_at", "DATETIME")
        _ensure_column("daily_mileage_snapshots", "late_updated_at", "DATETIME")
        _ensure_column("daily_mileage_snapshots", "approved_at", "DATETIME")
        _ensure_column("daily_mileage_snapshots", "approved_by", "VARCHAR(128)")
        _ensure_column("daily_mileage_snapshots", "excluded_at", "DATETIME")
        _ensure_column("daily_mileage_snapshots", "excluded_by", "VARCHAR(128)")
        _ensure_index(
    ...
    if "company_historical_rebuild_jobs" in existing_tables:
        ...
        _ensure_column("company_historical_rebuild_jobs", "current_device_offset", "INTEGER DEFAULT 0")
        _ensure_column("company_historical_rebuild_jobs", "mileage_days_total", "INTEGER DEFAULT 0")
        _ensure_column("company_historical_rebuild_jobs", "mileage_days_done", "INTEGER DEFAULT 0")
        _ensure_column("company_historical_rebuild_jobs", "mileage_devices_total", "INTEGER DEFAULT 0")
        _ensure_column("company_historical_rebuild_jobs", "mileage_devices_done", "INTEGER DEFAULT 0")
        _ensure_column("company_historical_rebuild_jobs", "mileage_rows_total", "INTEGER DEFAULT 0")
        _ensure_column("company_historical_rebuild_jobs", "mileage_rows_processed", "INTEGER DEFAULT 0")
        _ensure_column("company_historical_rebuild_jobs", "mileage_valid_days", "INTEGER DEFAULT 0")
        _ensure_column("company_historical_rebuild_jobs", "mileage_missing_days", "INTEGER DEFAULT 0")
        _ensure_column("company_historical_rebuild_jobs", "mileage_coverage_pct", "FLOAT")
        _ensure_column("company_historical_rebuild_jobs", "last_mileage_date", "DATE")
        _ensure_column("company_historical_rebuild_jobs", "degraded_publication_approved", "BOOLEAN DEFAULT FALSE")
        _ensure_column("company_historical_rebuild_jobs", "degraded_publication_approved_at", "DATETIME")
        _ensure_column("company_historical_rebuild_jobs", "degraded_publication_approved_by", "VARCHAR(128)")
