...
class AlarmHarvestRun(Base):
    ...
    provider_unique_dms_total: Mapped[int] = mapped_column(Integer, default=0)
    local_raw_dms_total: Mapped[int] = mapped_column(Integer, default=0)
    local_analytic_dms_total: Mapped[int] = mapped_column(Integer, default=0)
    temporal_dms_total: Mapped[int] = mapped_column(Integer, default=0)
    unexplained_dms_total: Mapped[int] = mapped_column(Integer, default=0)
    started_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    finished_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    error_message: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utc_now, onupdate=utc_now)
...
class AlarmHarvestDevice(Base):
    ...
    provider_unique_dms_rows: Mapped[int] = mapped_column(Integer, default=0)
    local_raw_dms_rows: Mapped[int] = mapped_column(Integer, default=0)
    local_analytic_dms_rows: Mapped[int] = mapped_column(Integer, default=0)
    temporal_dms_rows: Mapped[int] = mapped_column(Integer, default=0)
    unexplained_dms_rows: Mapped[int] = mapped_column(Integer, default=0)
